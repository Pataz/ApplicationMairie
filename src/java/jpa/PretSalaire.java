 ...
 */
@Entity
public class PretSalaire implements Serializable {
    ...
    public PretSalaire(PretSalaire absence) {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PretSalaire)) {
            return false;
        }
        PretSalaire other = (PretSalaire) object;
